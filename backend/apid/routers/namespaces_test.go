...
func TestPostNamespace(t *testing.T) {
	...
	controller.On("Create", mock.Anything, mock.AnythingOfType("v2.Namespace")).Return(nil)
...
func TestPutNamespace(t *testing.T) {
	...
	controller.On("CreateOrReplace", mock.Anything, mock.AnythingOfType("v2.Namespace")).Return(nil)
	...
	controller.AssertCalled(t, "CreateOrReplace", mock.Anything, mock.AnythingOfType("v2.Namespace"))
}

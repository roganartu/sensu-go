...
func TestCreateCommandRunEClosureWithAllFlags(t *testing.T) {
	...
	client.On("CreateCheck", mock.AnythingOfType("*v2.CheckConfig")).Return(nil)
...
func TestCreateCommandRunEClosureWithServerErr(t *testing.T) {
	...
	cli := test.NewMockCLI()
	client := cli.Client.(*client.MockClient)
	client.On("CreateCheck", mock.AnythingOfType("*v2.CheckConfig")).Return(errors.New("whoops"))
...
func TestCreateCommandRunEClosureWithMissingRequiredFlags(t *testing.T) {
	...
	cli := test.NewMockCLI()
	client := cli.Client.(*client.MockClient)
	client.On("CreateCheck", mock.AnythingOfType("*v2.CheckConfig")).Return(errors.New("error"))

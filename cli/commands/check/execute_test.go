...
func TestExecuteCommandRunEClosureSuccess(t *testing.T) {
	...
	client.On("ExecuteCheck", mock.AnythingOfType("*v2.AdhocRequest")).Return(nil)
...
func TestExecuteCommandRunEClosureServerErr(t *testing.T) {
	...
	client := cli.Client.(*clientmock.MockClient)
	client.On("ExecuteCheck", mock.AnythingOfType("*v2.AdhocRequest")).Return(errors.New("whoops"))

...
func TestSetCheckHooksCommandRunEClosureSucess(t *testing.T) {
	...
	client.On("AddCheckHook", mock.AnythingOfType("*v2.CheckConfig"), mock.AnythingOfType("*v2.HookList")).Return(nil)
...
func TestSetCheckHooksCommandRunEClosureServerErr(t *testing.T) {
	...
	client := cli.Client.(*clientmock.MockClient)
	client.On("AddCheckHook", mock.AnythingOfType("*v2.CheckConfig"), mock.AnythingOfType("*v2.checkHook")).Return(nil)

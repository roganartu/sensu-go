...
func TestCreateCommand(t *testing.T) {
	...
	client.On("PutResource", mock.AnythingOfType("*v2.Check")).Return(nil)
	client.On("PutResource", mock.AnythingOfType("*v2.Asset")).Return(nil)
	client.On("PutResource", mock.AnythingOfType("*v2.Hook")).Return(nil)

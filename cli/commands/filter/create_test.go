...
func TestCreateCommandRunEClosureWithAllFlags(t *testing.T) {
	...
	client.On("CreateFilter", mock.AnythingOfType("*v2.EventFilter")).Return(nil)
...
func TestCreateCommandRunEClosureWithServerErr(t *testing.T) {
	...
	cli := test.NewMockCLI()
	client := cli.Client.(*client.MockClient)
	client.On("CreateFilter", mock.AnythingOfType("*v2.EventFilter")).Return(errors.New("whoops"))

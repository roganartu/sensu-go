...
func TestDeleteCommandRunEClosureWithFlags(t *testing.T) {
	...
	client.On("DeleteFilter", mock.AnythingOfType("*v2.EventFilter")).Return(nil)
...
func TestDeleteCommandRunEClosureWithServerErr(t *testing.T) {
	...
	cli := test.NewMockCLI()
	client := cli.Client.(*client.MockClient)
	client.On("DeleteFilter", mock.AnythingOfType("*v2.EventFilter")).Return(errors.New("oh noes"))

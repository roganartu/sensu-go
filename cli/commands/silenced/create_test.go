...
func TestCreateCommandRunEClosureWithDeps(t *testing.T) {
	...
	cli := test.NewMockCLI()
	client := cli.Client.(*client.MockClient)
	client.On("CreateSilenced", mock.AnythingOfType("*v2.Silenced")).Return(nil)
...
func TestCreateCommandRunEClosureWithServerErr(t *testing.T) {
	...
	cli := test.NewMockCLI()
	client := cli.Client.(*client.MockClient)
	client.On("CreateSilenced", mock.AnythingOfType("*v2.Silenced")).Return(errors.New("whoops"))
...
func TestCreateCommandRunEClosureWithMissingRequiredFlags(t *testing.T) {
	...
	cli := test.NewMockCLI()
	client := cli.Client.(*client.MockClient)
	client.On("CreateSilenced", mock.AnythingOfType("*v2.Silenced")).Return(errors.New("error"))
